...
<template>
    <Head title="Password Manager Dashboard" />
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div :class="mainContentClasses">
            ...
            <main class="p-6">
                <!-- Stats Overview -->
                <StatsOverview :stats="stats" class="mb-8" />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    <DashboardWidget
                        ...
                        class="col-span-1"
                        :class="{
                            'lg:col-span-2': widget.position.w > 6,
                            'xl:col-span-2': widget.position.w > 8,
                            'xl:col-span-3': widget.position.w > 10
                        }"
                    />
                </div>
